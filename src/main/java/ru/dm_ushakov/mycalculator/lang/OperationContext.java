...
public class OperationContext {
	...
	private boolean antlrParseTreeDebugEnabled=false;
	...
	public boolean isAntlrParseTreeDebugEnabled() {
		return antlrParseTreeDebugEnabled;
	}
	
	public void enabledAntlrParseTreeDebug(boolean enabled) {
		antlrParseTreeDebugEnabled = enabled;
	}
	
	public void enabledAntlrParseTreeDebug() {
		enableAstDebug(true);
	}
