...
public class MyCalculator {
	public static void main(String[] args) {
		...
		context.assignFunction("enableAntlrParseTreeDebug", new EnableAntlrParseTreeDebugFunc());
		...
		while(true) {
			...
			try {
				if(context.isAntlrParseTreeDebugEnabled()) {
					Parser.printDebugParseTree(expression);
				} else {
					AbstractOperator operator = Parser.parseExpression(expression);
